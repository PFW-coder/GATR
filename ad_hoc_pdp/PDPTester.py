...
from PDPEnv import PDPEnv as Env
from PDPModel import PDPModel as Model
...
class PDPTester:
    ...
    def run(self):
        ...
        if self.tester_params['test_data_load']['enable']:
            ...
            self.env.set_random_seed(self.tester_params['test_random_seed'], self.tester_params['test_episodes'])
        ...
        while episode < test_num_episode:
            ...
            score_AM_list.append(score)
            aug_score_AM_list.append(aug_score)
